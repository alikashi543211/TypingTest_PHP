...
function Circlebar(prefs) {
    ...
    this.initialise = function() {
        ...
        that.maxValue = parseInt(attribs.circleMaxvalue) || parseInt(prefs.maxValue) || 300;
        that.counter = parseInt(attribs.circleCounter) || parseInt(prefs.counter) || 1000;
        that.dialWidth = parseInt(attribs.circleDialwidth) || parseInt(prefs.dialWidth) || 3;
        that.size = attribs.circleSize || prefs.size || "500px";
    ...
    this.textFilter = function() {
        ...
        if (that.type == "progress") {
            ...
            setDeceleratingTimeout(0.5, 100);
        }
    }
    this.textFilter();
